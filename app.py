...
def merge():
   ...
   if request.method == "OPTIONS": # CORS preflight
        return _build_cors_prelight_response()
                ...
                number2=0
                try:
                    number1=content["contpage"]
                    number2=content["clapage"]
                except:
                    return _corsify_actual_response(jsonify("Please try again!!!!! Parameters error"))
                  #################contract types
                Filename="./contractCollection.csv"         
                ...
                for index, row in df.iterrows() :
                    if len(array)<10:
                        ...
                        break
                array4=[]
                array4.append({"pages":totalpages})
                array4.append({"data":array})
                array=array4
                #print(array)
